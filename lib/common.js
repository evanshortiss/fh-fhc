...
/**
 * Creates a table that can be printed for git references
 * @param {Array<Object>}
 */
exports.createTableForGitRefs = function (refs) {
  const table = new Table({
    head: ['Type', 'Name', 'Hash'],
    style: exports.style()
  });

  refs.sort((a, b) => a.type < b.type ? -1 : 1);

  refs.forEach((r) => {
    table.push([r.type, r.value, r.hash]);
  });
